...
function EditCriteria() {
  ...
  console.log(location.state?.criteria, "inside edit criteria adjust ",location.state?.id);
  ...
  <Back text='Back To Plan' onClick={() => { navigate('/dashboard/seniorExaminer/plan') }}/>
    ...
    <form onSubmit={handleSubmit} className="p-6 space-y-6">
        ...
        <table className="min-w-full text-sm divide-y divide-gray-200 dark:divide-gray-700">
          <tbody>
            ...
            <tr
              ...
              `}
            >
              <td className="px-6 py-3 text-center dark:text-white" colSpan={2}>
      ...
      <div className="flex justify-end">
        <button
          ...
          className={`
            flex items-center px-6 py-3 rounded-lg font-medium text-white transition
            ${totalWeight === 100
