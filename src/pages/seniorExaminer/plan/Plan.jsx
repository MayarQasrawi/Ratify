...
export default function Plan() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 mt-[8vh] bg-white rounded-lg shadow-md r">
      ...
      <div className="text-center">
        <button
          onClick={()=>navigate('/dashboard/seniorExaminer/plan-setup')}
        ...
        >
          <FiPlus />
          <span className="hidden sm:inline">Add First Level</span>
        </button>
      </div>
    </div>
  );
