         ...
         {selectedAction == "toggle" && (
                <Modal>
                  <ConfirmationModal
                    ...
                    Confirm={() =>
                stageIndex.current
                  ? ActivatePlanStructer(`Stages/${stageIndex.current.id}/restore`)
                  : ActivatePlanStructer(`Levels/${levelIndex.current.id}/restore`)
              }
                    isPending={isActivatePending}
                    isSuccess={isActivateSuccess}
                    isError={isActivateError}
              ...
              <Accordion
                ...
                title={
                  <div className="flex items-center justify-between w-full">
                   ...
                   {lvl.isActive && <div className="flex items-center ml-1">
                      <button
                        onClick={() => {
                          handleEditLevel(lvl);
                        }}
