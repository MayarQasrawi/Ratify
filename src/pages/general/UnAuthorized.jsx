    ...
    <div className="max-w-md w-full bg-white rounded-lg shadow-xl overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="flex space-x-3">
          <button onClick={()=>{navigate('/')}} className="flex-1 bg-red-500 cursor-pointer hover:bg-red-600 text-white py-2 px-4 rounded-md font-medium transition duration-200">
            Go To Home
          </button>
