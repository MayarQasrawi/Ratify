...
import { MdInfoOutline, MdAccessTime, MdAssignment } from 'react-icons/md';
  ...
  return (
    <div className="flex flex-wrap gap-4 justify-around p-6 py-10">
      ...
      <Card 
        ...
        descriptions={data?.requestStatus || ''} 
      ...
      <Card 
        ...
        descriptions={data?.scheduledDate ? new Date(data.scheduledDate).toLocaleDateString() : ''} 
        className="border border-gray-100"
      />)}
