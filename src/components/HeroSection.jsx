...
function HeroSection() {
  return (
     ...
     <div className='absolute h-screen w-[100%] rotate-[-8deg] mt-[-180px] z-0  rounded-[80px] overflow-x-hidden bg-blue-50 '>
...
<section className='flex  justify-between w-screen  items-center min-h-screen mx-8 z-1 pt-19 p-9 '>
     ...
     <motion.h1 className="text-4xl  md:text-5xl font-bold text-[#003F7DDE] mb-6"
    ...
    <span className='text-[#3B82F6]'>Evaluate</span>  Your Skills
     <br />
<span className='text-[#3B82F6]'>Discover</span> Your True 
Potential
     </motion.h1> 

     <p className="text-lg text-gray-700 mb-8 ">
     Get certified and take the next step toward success.          </p>
