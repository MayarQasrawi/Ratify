      ...
      <div className="flex  mt-8 flex-raw  justify-center gap-3  items-center">
       ...
       <div className=" w-[60%] mt-8 flex justify-center gap-8  flex-wrap">
          <div className="bg-white  cursor-pointer hover:translate-y-[-10px] transition duration-300 rounded-2xl  p-6 w-[200px] shadow-md flex flex-col items-center gap-2  ">
             <span className="text-[#3B82F6] font-bold sm:text-5xl text-left  text-4xl">100</span>
          ...
          <div className="bg-white cursor-pointer hover:translate-y-[-10px] transition duration-300 rounded-2xl  p-6 w-[200px] shadow-md flex flex-col items-center gap-2 ">
             <span className="text-[#3B82F6] font-bold  text-4xl sm:text-5xl">50</span>
             <div className="flex gap-2 items-center text-left text-[#303030]"> <FaBookOpen size={30} /> <span className="text-[16px] font-medium">Track <br />Available</span> </div>
          </div>
          <div className=" bg-[#3B82F6] rounded-2xl  hover:bg-[#003F7D] transition p-6 text-center shadow text-white text-[20px] sm:text-2xl font-bold md:w-[380px] lg:w-[430px]">
