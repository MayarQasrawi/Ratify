...
export default function Work() {
  return (
    ...
    <h2 className="bg-[#3B82F6] mx-auto z-20 relative -bottom-3 text-white font-bold w-fit px-7 py-2 text-center rounded-md">
      How It Works
    </h2>
  
    <div className="bg-[#003F7D] relative z-10 rounded-2xl py-8 px-3 items-start flex md:items-center gap-2 ">
