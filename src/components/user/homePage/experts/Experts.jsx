...
export default function Experts() {
  ...
  return (
    <section className="w-[90%] mx-auto mt-22 relative">
      <div className="flex flex-wrap lg:flex-nowrap gap-8 items-center justify-center bg-radial-[at_100%_75%]   from-[rgba(0,63,125,0.5)] to-[rgba(161,186,239,0.5) px-8 py-10 lg:rounded-full">
