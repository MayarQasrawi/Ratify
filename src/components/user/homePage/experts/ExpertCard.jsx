...
export default function ExpertCard({ img, name,role,isLoading }) {
  return (
   <>
    {isLoading?<div className="bg-gray-300 mt-3 mx-auto w-[180px] h-[180px] rounded-lg   animate-pulse"></div>:<div className="rounded-lg cursor-pointer w-fit mx-auto sm:mx-0 border-3 border-white  hover:scale-105 transition duration-300 ">
