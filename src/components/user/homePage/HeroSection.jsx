    ...
    <div>
      ...
      <section className="flex   justify-between w-screen  items-center min-h-screen mx-8 z-1  md:p-9 ">
        <article className="flex1 w-[100%]   md:w-2/3 text-center md:text-left z-1 ">
          ...
          <button onClick={()=>navigate('/our-tracks')} className="bg-[#003F7DDE] text-white w-48 font-bold py-3 cursor-pointer rounded-lg hover:bg-[#3B82F6] transition duration-300">
            Join Us
          </button>
        </article>
