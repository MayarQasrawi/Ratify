  ...
  return (
    <div className="min-h-screen bg-gray-50 m-0 overflow-x-hidden">
      ...
      <div className="min-h-screen   items-center">
        <h1 className="text-4xl md:text-5xl font-bold text-[#003F7DDE] mb-20 text-center"  // Animation duration and delay
        >
        ...
        <section className="flex flex-wrap items-center justify-center gap-20 p-6 mb-8">
          {why.map((item, index) => (
            <Card key={index} header={item.header} text={item.text} image={<img src={item.image} alt="image"  />}/>
          ))}
